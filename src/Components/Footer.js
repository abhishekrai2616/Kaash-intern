      ...
      <div class="container px-6 py-6 mx-auto">
        <div class="grid grid-cols-2 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
          <div class="sm:col-span-2 col-start-1 col-span-2 ">
            <h1 class="max-w-lg text-xl font-light tracking-tight text-zinc-300 xl:text-2xl">
            ...
            <p className="max-w-md text-xs font-extralight tracking-tight text-zinc-300 mt-5">
          ...
          <div>
            <p class="font-light text-zinc-300 :">Quick Links</p>
            <div class="flex flex-col items-start mt-1 space-y-1 text-zinc-300 w-40 text-sm 2xl:text-lg">
              <a
                href="#"
                class="!text-zinc-300 font-extralight transition-colors duration-300 hover:underline hover:text-blue-500"
              >
                Contact
              </a>
              <a
        ...
        <hr class="my-4 border-zinc-600 md:my-6 " />
        <div class="flex items-center justify-between">
          ...
          <div class="flex -mx-2">
            <a
              ...
              target="_blank"
              class="mx-2 !text-zinc-300 transition-colors duration-300 hover:text-blue-500 text-3xl"
              aria-label="Reddit"
            >
              <GrFacebookOption />
            </a>
